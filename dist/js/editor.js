...
/* harmony import */ var _editor_hero_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editor/hero/index.js */ "./assets/js/editor/hero/index.js");
...
addFilter('taproot.plugin.hook', 'skyshab/taproot/taprootPluginHook', function (components) {
  return [components, React.createElement(_editor_sidebar_EnableHero_js__WEBPACK_IMPORTED_MODULE_1__["EnableHero"], {
    fieldName: "taprooot_add_hero_content"
  })];
}, 40); // example of removing one of the controls from the sidebar

addAction('taproot.plugin.defaultsLoaded', 'skyshab/taprootPlugin/components', function () {// removeFilter( 'taproot.plugin.hook', 'skyshab/taproot/postTitle' );
...
addAction('taproot.plugin.headerImageChange', 'skyshab/taprootPlugin/components', function (image) {
  var headerContentBlock = document.querySelector('.wp-block-taproot-hero');

  if (headerContentBlock) {
    var blockID = headerContentBlock.parentElement.dataset.block;
...
function HeroEdit(_ref) {
  ...
  if (backgroundImage) {
    ...
    classes = classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, {
...
/***/ "./assets/js/editor/hero/index.js":
/*!****************************************!*\
  !*** ./assets/js/editor/hero/index.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit */ "./assets/js/editor/hero/edit.js");
...
var InnerBlocks = window.wp.blockEditor.InnerBlocks;
function save() {
  var className = classnames__WEBPACK_IMPORTED_MODULE_0___default()('container');
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _meta__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./meta */ "./assets/js/editor/meta/meta.js");
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities */ "./assets/js/editor/meta/utilities.js");
...
function MetaEdit(_ref) {
  ...
  })), React.createElement(_meta__WEBPACK_IMPORTED_MODULE_1__["default"], {
    metaItems: metaItems,
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('wp-block--taproot-meta taproot-meta', (_classnames = {}, _defineProperty(_classnames, "has-text-align-".concat(attributes.align), attributes.align), _defineProperty(_classnames, textColor.class, textColor.class), _defineProperty(_classnames, 'has-text-color', textColor.color), _classnames)),
    style: {
...
/* harmony default export */ __webpack_exports__["default"] = (compose([withColors('backgroundColor', {
  ...
  if (attributes.author) {
    metaItems.push({
      name: 'author',
      icon: 'author',
      value: Object(_utilities__WEBPACK_IMPORTED_MODULE_2__["getTheAuthor"])(select)
    });
  }
  ...
  if (attributes.date) {
    metaItems.push({
      name: 'date',
      icon: 'date',
      value: Object(_utilities__WEBPACK_IMPORTED_MODULE_2__["getTheDate"])(select)
    });
  }
    ...
    allTaxonomies.map(function (taxonomy) {
      if (taxonomy.types.includes(postType)) {
        ...
        if (values[taxName]) {
          ...
          var icon = taxonomy.hierarchical ? 'categories' : 'tags';
          metaItems.push({
            name: taxName,
            icon: icon,
...
/***/ "./assets/js/editor/meta/index.js":
/*!****************************************!*\
  !*** ./assets/js/editor/meta/index.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilities */ "./assets/js/editor/meta/utilities.js");
...
/*#__PURE__*/
function (_Component) {
  _inherits(TaprootMeta, _Component);

  function TaprootMeta() {
    _classCallCheck(this, TaprootMeta);

    return _possibleConstructorReturn(this, _getPrototypeOf(TaprootMeta).apply(this, arguments));
  }

  _createClass(TaprootMeta, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          style = _this$props.style,
          className = _this$props.className,
          metaItems = _this$props.metaItems;
      var block = "taproot-meta";
      var icons = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["getIcons"])();
      var metaContent = [];
      ...
      if (metaItems) {
        metaItems.map(function (item) {
          ...
          if (Array.isArray(item.value)) {
            ...
            item.value.forEach(function (term, index) {
              itemTerms.push(createElement('a', {
                href: '#'
              }, term)); // add comma after all but the last item
          ...
          itemWrapper.push(createElement('span', {
            className: "".concat(block, "__item__content ").concat(block, "__item__content--").concat(item.name)
          }, value));
          metaContent.push(createElement('span', {
            className: "".concat(block, "__item ").concat(block, "__item--").concat(item.name)
          }, itemWrapper));
        });
      }
...
/* harmony default export */ __webpack_exports__["default"] = (TaprootMeta);

/***/ }),

/***/ "./assets/js/editor/meta/transforms.js":
/*!*********************************************!*\
  !*** ./assets/js/editor/meta/transforms.js ***!
  \*********************************************/
/*! exports provided: default */
...
/***/ "./assets/js/editor/meta/utilities.js":
/*!********************************************!*\
  !*** ./assets/js/editor/meta/utilities.js ***!
  \********************************************/
/*! exports provided: getTheAuthor, getTheDate, getTaxonomyList, taxonomyToggles, getIcons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taxonomyToggles", function() { return taxonomyToggles; });
...
function getTheAuthor(select) {
  var postAuthor = select('core/editor').getEditedPostAttribute('author');
  var authors = select('core').getAuthors();
  var authorName = '';

  for (var i = 0; i < authors.length; i++) {
    var theAuthor = authors[i];
...
function taxonomyToggles(setAttributes, controls, taxonomies) {
  ...
  controls.map(function (control) {
    toggles.push(React.createElement(ToggleControl, {
      label: control.label,
...
function getIcons() {
  return {
    author: React.createElement(Icon, {
      className: "taproot-icon",
      size: "100%",
      viewBox: "0 0 20 28",
      icon: React.createElement("svg", null, React.createElement("path", {
    ...
    categories: React.createElement(Icon, {
      className: "taproot-icon",
      size: "100%",
      viewBox: "0 0 28 28",
      icon: React.createElement("svg", null, React.createElement("path", {
...
/***/ "./assets/js/editor/sidebar/EnableHero.js":
/*!************************************************!*\
  !*** ./assets/js/editor/sidebar/EnableHero.js ***!
  \************************************************/
/*! exports provided: EnableHero */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EnableHero", function() { return EnableHero; });
/**
...
var EnableHero = compose(withDispatch(function (dispatch) {
  return {
    setCheckboxValue: function setCheckboxValue(value) {
      dispatch('core/editor').editPost({
        meta: {
          taprooot_add_hero_content: value
        }
      });
    }
  };
  ...
  var addBlock = function addBlock() {
    var block = savedBlock ? savedBlock : createBlock('taproot/hero');
...
/***/ "./assets/js/editor/title/edit.js":
/*!****************************************!*\
  !*** ./assets/js/editor/title/edit.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _toolbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toolbar */ "./assets/js/editor/title/toolbar.js");
/* harmony import */ var _title__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./title */ "./assets/js/editor/title/title.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function TitleEdit(_ref) {
  ...
  var tagName = 'h' + level;
  return React.createElement(React.Fragment, null, React.createElement(BlockControls, null, React.createElement(_toolbar__WEBPACK_IMPORTED_MODULE_1__["default"], {
    minLevel: 1,
    maxLevel: 3,
    selectedLevel: level,
  ...
  }, React.createElement("p", null, __('Level')), React.createElement(_toolbar__WEBPACK_IMPORTED_MODULE_1__["default"], {
    minLevel: 1,
    maxLevel: 3,
    selectedLevel: level,
    onChange: function onChange(newLevel) {
    ...
    content: content,
    tagName: tagName,
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, (_classnames = {}, _defineProperty(_classnames, "has-text-align-".concat(align), align), _defineProperty(_classnames, 'has-text-color', textColor.color), _defineProperty(_classnames, textColor.class, textColor.class), _classnames)),
    style: {
      color: textColor.color
    }
  }));
...
/***/ "./assets/js/editor/title/index.js":
/*!*****************************************!*\
  !*** ./assets/js/editor/title/index.js ***!
  \*****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit */ "./assets/js/editor/title/edit.js");
/* harmony import */ var _transforms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./transforms */ "./assets/js/editor/title/transforms.js");
/**
 * Title Block
 *
 * This file handles the JavaScript for creating a custom block
...
/***/ "./assets/js/editor/title/title.js":
/*!*****************************************!*\
  !*** ./assets/js/editor/title/title.js ***!
  \*****************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Component) {
  _inherits(TaprootTitle, _Component);

  function TaprootTitle() {
    _classCallCheck(this, TaprootTitle);

    return _possibleConstructorReturn(this, _getPrototypeOf(TaprootTitle).apply(this, arguments));
  }

  _createClass(TaprootTitle, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
...
/* harmony default export */ __webpack_exports__["default"] = (TaprootTitle);

/***/ }),

/***/ "./assets/js/editor/title/toolbar.js":
/*!*******************************************!*\
  !*** ./assets/js/editor/title/toolbar.js ***!
  \*******************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Component) {
  _inherits(TitleToolbar, _Component);

  function TitleToolbar() {
    _classCallCheck(this, TitleToolbar);

    return _possibleConstructorReturn(this, _getPrototypeOf(TitleToolbar).apply(this, arguments));
  }

  _createClass(TitleToolbar, [{
    ...
    value: function render() {
      ...
      return React.createElement(Toolbar, {
        controls: Object(lodash__WEBPACK_IMPORTED_MODULE_0__["range"])(minLevel, maxLevel).map(function (index) {
...
/* harmony default export */ __webpack_exports__["default"] = (TitleToolbar);

/***/ }),

/***/ "./assets/js/editor/title/transforms.js":
/*!**********************************************!*\
  !*** ./assets/js/editor/title/transforms.js ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ 0:
/*!***************************************************************************************!*\
  !*** multi ./assets/js/editor.js ./assets/scss/screen.scss ./assets/scss/editor.scss ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/sky/Repos/skyshab/taproot-plugin/assets/js/editor.js */"./assets/js/editor.js");
__webpack_require__(/*! /Users/sky/Repos/skyshab/taproot-plugin/assets/scss/screen.scss */"./assets/scss/screen.scss");
module.exports = __webpack_require__(/*! /Users/sky/Repos/skyshab/taproot-plugin/assets/scss/editor.scss */"./assets/scss/editor.scss");
